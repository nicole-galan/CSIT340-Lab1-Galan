      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <section className="mb-10">
          ...
          <p className="leading-relaxed text-slate-700">
            I was born and raised in Cebu and I, unfortunately, still live in the same city. I picked IT because a close cousin of mine have been in the field for a decade
            and I wanted the same free lifestyle. 
          </p>
        </section>
