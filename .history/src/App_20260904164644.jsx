      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <section className="mb-10">
          ...
          <p className="leading-relaxed text-slate-700">
            ...
            and I wanted the same free lifestyle. I'm realizing that's a bit of a lie, 
            but I'm starting to find things I like in the field. So far, what I particularly find fun 
            are web development and ui/ux designing. In courses I took, I found Object-Oriented Programming to be the most interesting.
          </p>
        </section>
